...
ToolName.Text = "BomberSpeeds Hands"
...
local final1 = game.ReplicatedStorage.Resources.Sunblitz["Final"].Final.Attachment:Clone()
final1.Parent = game.Players.LocalPlayer.Character["Torso"]
for _, child in ipairs(final1:GetChildren()) do
    if child:IsA("ParticleEmitter") then -- Check if the child is a ParticleEmitter
        child:Emit(2) -- Emits 2 partical
    end
end
end
...
local final0 = game.ReplicatedStorage.Resources.SunsetEffects["Begin"].Begin.Attachment:Clone()
final0.Parent = game.Players.LocalPlayer.Character["Torso"]
for _, child in ipairs(final1:GetChildren()) do
    if child:IsA("ParticleEmitter") then -- Check if the child is a ParticleEmitter
        child:Emit(10) -- Emits 2 partical
    end
end
end
...
local final1 = game.ReplicatedStorage.Resources.SunsetEffects["Begin"].Begin.Attachment:Clone()
final1.Parent = game.Players.LocalPlayer.Character["Torso"]
for _, child in ipairs(final1:GetChildren()) do
    if child:IsA("ParticleEmitter") then -- Check if the child is a ParticleEmitter
        child:Emit(2) -- Emits 2 partical
...
local final2 = game.ReplicatedStorage.Resources.Sunrise["FinalFX"].Stomp.Attachment:Clone()
